  ...
  return (
    <aside className="hidden md:block w-[240px] mx-auto" style={{ position: "sticky", top: "var(--sticky-top,112px)" }}>
      <div
        ...
        style={{ height: desiredHeight ?? undefined, overflow: "auto" }}
      >
        <div>
        ...
        <footer className="pt-4 border-t border-white/10">
          ...
          <ul className="grid grid-cols-2 md:grid-cols-2 gap-x-5 gap-y-3 text-sm">
            ...
            <li><a href={SOCIAL_LINKS.x}        target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:underline"><TwitterIcon className="h-5 w-5" />Twitter</a></li>
          </ul>
